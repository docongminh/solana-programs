...
(async () => {
  const idl = require("/Users/minhdo/Documents/learning/solana-programs/transfer/target/idl/transfer.json");
  ...
  const associatedTokenAccount = await getAssociatedTokenAddress(
    new PublicKey("9mw9qp7gdHzNRn9kRych4NMw6zXYySnVUrZF9H8bziRp"),
  ...
  const tx1 = await program.rpc.transferToken(new BN(10000), {
    accounts: {
